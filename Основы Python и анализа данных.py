...
columns = ['user_id', 'track_name', 'artist_name', 'genre_name', 'city', 'time', 'weekday']# <перечень названий столбцов таблицы df>
...
df.drop_duplicates(inplace=True) # <удаление всех дубликатов из таблицы df специальным методом>
...
sobaka = genre_weekday(moscow_general, 'Monday', '07:00:00', '11:00:00') # <вызов функции для утра понедельника в Москве (вместо df таблица moscow_general)>


# In[33]:


sobaka1 = genre_weekday(spb_general, 'Monday', '07:00:00', '11:00:00') # <вызов функции для утра понедельника в Петербурге (вместо df таблица spb_general)>


# In[34]:


sobaka2 = genre_weekday(moscow_general, 'Friday', '17:00:00', '23:00:00') # <вызов функции для вечера пятницы в Москве>


# In[46]:


sobaka3 = genre_weekday(spb_general, 'Friday', '17:00:00', '23:00:00') # <вызов функции для вечера пятницы в Питере>
...
moscow_genrs = moscow_general.groupby('genre_name')['genre_name'].count()
moscow_genres = moscow_genrs.sort_values(ascending = False)
...
spb_genrs = spb_general.groupby('genre_name')['genre_name'].count()
spb_genres = spb_genrs.sort_values(ascending = False) # <группировка таблицы spb_general, расчёт, сохранение в spb_genres>
